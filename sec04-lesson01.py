...
class RagResponse(BaseModel):
    ...
    follow_up: str = Field(
        description="Suggested follow-up question based on the answer."
    )
...
Answer:
    ...
    for question in questions:
        ...
        reg_response = cast(RagResponse, chain.invoke({"question": question}))
        print(f"Answer: {reg_response.answer}")
        print(f"Confidence: {reg_response.confidence}")
        print(f"Sources Used: {', '.join(reg_response.sources_used)}")
        print(f"Follow-up: {reg_response.follow_up}")
        print("---")
